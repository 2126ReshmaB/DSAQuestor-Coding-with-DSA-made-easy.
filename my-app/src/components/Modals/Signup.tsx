...
const Signup:React.FC<SignupProps> = () => {
    ...
    const handleRegister = async (e:React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        if(!inputs.email || !inputs.password || !inputs.displayName) return alert("pleasse fill all fields");
        try{
    ...
    <h3 className='text-x; font-medium text-white'>Register to LeetClone</h3>
    <div>
    ...
    <div>
        <label htmlFor='displayName' className='text-sm font-medium block mb- text-gray-300'>
            Display Name
        </label>
        <input
        onChange = {handleChangeInput}
