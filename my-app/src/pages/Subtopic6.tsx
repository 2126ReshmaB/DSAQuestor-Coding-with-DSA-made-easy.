  ...
  return (
    ...
    <Topbar problemPage/>
      <div className='flex flex-wrap justify-center items-center mt-10 mb-5'>
            ...
            <h1  style={{borderRadius: '10px',boxShadow: '0 0 20px rgba(0, 0, 0, 0.9)'}} className='text-lg px-8 py-3 mx-2 bg-blue-800 text-white rounded-md focus:outline-none focus:ring focus:border-blue-300'>LinkedList</h1>
    ...
    <div  style={{height: '300px'}}  className='flex space-x-10'>
      ...
      <div style={{height: '300px',borderRadius: '10px',boxShadow: '0 0 20px rgba(0, 0, 0, 0.9)'}} className='mr-4 shadow-lg'>
          ...
          <h1 className='text-white py-2'><b>LinkedList</b></h1>
            {text1Ref.current}
          </div>
      ...
      <iframe style={{ height: '300px', lineHeight: '20px',width: '600px', boxShadow: '0 0 20px rgba(0, 0, 0, 0.9)',borderRadius: '29px' }}  className='px-2 py-2'
        ...
        width='100%'
        height='315'
        src='https://www.youtube.com/embed/58YbpRDc4yw'
...
<br /><br /><br />
<br />
<h1 className='text-white flex flex-wrap justify-center items-center'><b>Why choose a linked list over an array, and what is its structure?</b></h1>
<div className='py-20 px-20'>
            ...
            <img
                    src='ll.png'
                    alt='Image Alt Text'
                    style={{ height: '422px', borderRadius: '30px',width: '700px' }}
                  />
                  <div>
          ...
          <img
                    src='ll1.png'
                    alt='Image Alt Text'
                    style={{ height: '422px', borderRadius: '30px',width: '900px' }}
                  />
                  <p className='text-white text-center mt-1'>Node diagram</p>
                  </div>
            </div>
...
<br />
<br />
<h1 className='text-white flex flex-wrap justify-center items-center'><b>Let's begin with LinkedList and Node creation..</b></h1>
<div className='flex space-x-20 py-20 px-20'>

            <div style={{ height: '280px', lineHeight: '20px',width: '670px',boxShadow: '0 0 20px rgba(0, 0, 0, 0.9)',borderRadius: '29px' }} className='flex space-x-5'>
            <div style={{width:'350px',height: '300px'}} className='rounded-md py-5'>
        <h1 className='text-gray-500 px-2 py-4'>Java class for creating a Node</h1>
        ...
        <div>
          <h1 className='text-gray-500 py-9'>Operations on LinkedList</h1>
          <p className='text-white'>*    Insertion</p><br/>
          <p className='text-white'>*    Deletion</p><br/>
          <p className='text-white'>*    Searching</p><br/>
...
<div style={{ height: '280px', lineHeight: '20px',width: '600px', boxShadow: '0 0 20px rgba(0, 0, 0, 0.9)',borderRadius: '29px' }} className='flex space-x-10 px-8'>
...
<br />
<h1 className='text-white flex flex-wrap justify-center items-center'><b>Types of Linked List</b></h1>
<div className='justify-center items-center px-20 flex space-x-20'>
 <img 
  src='sl.png'
  alt='Image Alt Text'
  style={{ height: '250px', borderRadius: '30px',width: '900px' }}/>
</div>
<div className='justify-center items-center px-20 flex space-x-20'>
 <img 
  src='dl.png'
  alt='Image Alt Text'
  style={{ height: '250px', borderRadius: '30px',width: '700px' }}/>
</div>
<div className='justify-center items-center px-20 flex space-x-20'>
 <img 
  src='cl.png'
...
<table className='text-sm text-left text-gray-500 dark:text-gray-400 sm:w-7/12 w-full max-w-[1200px] mx-auto'>
    ...
    <tr>
      ...
      <div className='flex flex-wrap py-3 px-6'>
        <Link href='https://leetcode.com/problems/reverse-linked-list-ii/description/'>
    ...
    <tr>
      ...
      <td scope='col' className='bg-dark-layer-1 text-white px-6 py-3 w-0 font-medium'>
      <div className='flex flex-wrap py-3 px-6'>
        <Link href='https://leetcode.com/problems/house-robber/9s/4465354/java-code-Linked List-beats-100/'>
          <h1  className='cursor-pointer text-white ease-in-out'>Click here</h1>
        </Link>
      </div>
      </td>
