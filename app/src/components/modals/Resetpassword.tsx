...
const Resetpassword:React.FC<ResetpasswordProps> = () => {
    ...
    return (
        <form className='space-y-6 px-6 lg:px-8 pb-4 sm:pb xl:pb-8'>
            <h3 className='text-xl font-medium text-white'>Reset Password</h3>
            <p className='text-sm text-white'>
                Forgotton your password? Enter your e-mail address below, and we&apos;ll send you an e-mail allowing you to 
                reset it.
            </p>
            <div>
